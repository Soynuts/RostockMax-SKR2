...
#define STRING_CONFIG_H_AUTHOR "(Stefan Jonasson, SKR-2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rostock MAX SKR-2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd_LIST { 39.64, 39.64 }
  #else
    #define DEFAULT_Kp 15.9797
    #define DEFAULT_Ki 0.9444
    #define DEFAULT_Kd 67.5941
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 181.6370
  #define DEFAULT_bedKi 31.7547
  #define DEFAULT_bedKd 692.6426
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 155   // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 290.8        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 353.9             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 218 }  // Extruder steps/mm copied from 2021-04-15.epr (437 divide by 2)
